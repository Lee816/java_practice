...
public class PTS {
    ...
    // java.sql.Date -> yyyy-MM-dd
    public static String toSDate2(java.util.Date msg){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static void main(String[] args) {
        ...
        String SQL=""+" SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,    "+" EMAIL,PHONE_NUMBER,HIRE_DATE FROM EMPLOYEES    "+" START WITH EMPLOYEE_ID =?    "+" CONNECT BY PRIOR EMPLOYEE_ID = MANAGER_ID";
        log(SQL);
        log(log2(SQL,"100"));
    }
}
